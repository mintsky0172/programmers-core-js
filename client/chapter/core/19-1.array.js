...
// 배열 요소 제거
let shift = friends.shift(); // 창식
let pop = friends.pop(); // 현빈
...
let copiedArray2 = Array.from(friends);
let copiedArray3 = friends.slice();

let arr = friends; // 참조에 의한 복사(얕은 복사 아님) -> 하면 안됨
